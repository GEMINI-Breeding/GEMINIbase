...
-- Experiments Table
-- Stores information about the experiments, including for GEMINIbase
...
-------------------------------------------------------------------------------
-- Data Types Table
-- This is where we will store all possible Data Types that are compatible with GEMINIbase
...
-------------------------------------------------------------------------------
-- Data Formats Table
-- This is where we will store all possible Data Formats that are compatible with GEMINIbase
-- Stores File Formats
...
-------------------------------------------------------------------------------
-- Trait Levels Table
-- This is where we will store all possible Trait Levels that are compatible with GEMINIbase
...
-------------------------------------------------------------------------------
-- Sensor Types Table
-- This is where we will store all possible Sensor Types that are compatible with GEMINIbase
