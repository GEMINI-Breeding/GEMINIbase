...
class ModelRecordModel(ColumnarBaseModel):
    ...
    def _bulk_delete_in_session(cls, session, column_name: str, value: str) -> int:
        ...
        try:
            ...
            session.execute(
                text(
                    f"DELETE FROM gemini.model_records_immv "
    ...
    @classmethod
    def delete_by_model(cls, model_name: str, session=None) -> int:
        return cls._bulk_delete("model_name", model_name, session=session)
