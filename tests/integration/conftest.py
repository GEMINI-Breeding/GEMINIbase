...
def clean_db(setup_real_db):
    ...
    tables = [
        ...
        "gemini.experiment_populations", "gemini.experiment_datasets",
        "gemini.experiment_models", "gemini.experiment_procedures",
        "gemini.experiment_genotyping_studies", "gemini.experiment_scripts",
        ...
        "gemini.resources",
        "gemini.reference_plots", "gemini.reference_datasets",
        "gemini.plot_geometry_versions",
        "gemini.experiment_files",
        "gemini.user_experiments", "gemini.users",
        "gemini.genotyping_study_samples",
        "gemini.genotyping_study_variants",
        "gemini.genotyping_study_variant_stats",
        "gemini.genotyping_study_files",
